...
interface ConfigurableModule {
    ...
    fun <T> bindInternal(target: Class<T>, name: String? = null, initializer: ComponentInitializer<T>)
    fun <T> bindInternalDefault(target: Class<T>, name: String?, initializer: ComponentInitializer<T>)
